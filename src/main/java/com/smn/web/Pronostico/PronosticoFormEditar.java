...
public class PronosticoFormEditar {
	...
	public PronosticoFormEditar() {
		super();
	}

	public PronosticoFormEditar(Date fecha, int probabilidad, int cantidad, String descripcion, Ciudad ciudad) {
		super();
		this.fecha = fecha;
